# filename: locate_search_trigger.py
...
# Locate the search trigger element
search_trigger = soup.find("a", href=lambda href: href and "javascript:__doPostBack" in href)
