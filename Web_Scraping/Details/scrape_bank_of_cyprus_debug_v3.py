# filename: scrape_bank_of_cyprus_debug_v3.py
...
with open('search_results_debug_v3.html', 'w', encoding='utf-8') as file:
    file.write(soup.prettify())

print("The HTML content of the search results page has been saved to 'search_results_debug_v3.html'.")
